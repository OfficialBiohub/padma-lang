...
| P2 | Quantum circuit planning | Implemented first foundation | `quantum.*` validates bounded local circuit maps and emits/writes deterministic OpenQASM 3.0. It does not simulate, execute, submit, authenticate to, or select a quantum provider/QPU. |
